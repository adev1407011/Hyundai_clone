...
const BookingForm = () => {
  ...
  return (
    <div>
        ...
        <center><h1>Enter the Booking Details and the Details to be Updated</h1></center>
    <form action="http://localhost:5500/book_upd" method="post" style={{width:'100%',paddingTop:'3%',paddingLeft:'15%', paddingRight:'15%', fontSize:'large'}}>
